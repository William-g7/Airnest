        ...
        <>
          <div className="mt-4 space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span>
                <CurrencyDisplay amount={totals.cleaningFee} />
              </span>
            </div>
            <div className="flex justify-between">
              <span className="underline">{t('serviceFee')}</span>
              <span>
                <CurrencyDisplay amount={totals.serviceFee} />
              </span>
            </div>
            <div className="flex justify-between">
              <span className="underline">{t('taxes')}</span>
              <span>
                <CurrencyDisplay amount={totals.taxes} />
              </span>
            </div>
          </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-300 flex justify-between font-bold">
            <span>{t('total')}</span>
            <span>
              <CurrencyDisplay amount={totals.total} showOriginal={true} />
            </span>
          </div>
        </>
      )}
