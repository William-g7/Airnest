      ...
      >
        <div className="flex-1 flex">
          <div className="flex flex-row items-center justify-between w-full">
            ...
            >
              <p
                className={`text-xs font-semibold ${activeFilter === 'location' ? 'text-airbnb' : ''}`}
              >
                {t('where')}
              </p>
            ...
            >
              <p
                className={`text-xs font-semibold ${activeFilter === 'checkIn' ? 'text-airbnb' : ''}`}
              >
                {t('checkIn')}
              </p>
            ...
            >
              <p
                className={`text-xs font-semibold ${activeFilter === 'checkOut' ? 'text-airbnb' : ''}`}
              >
                {t('checkOut')}
              </p>
              <p className="text-sm truncate">
            ...
            >
              <p
                className={`text-xs font-semibold ${activeFilter === 'guests' ? 'text-airbnb' : ''}`}
              >
                {t('who')}
              </p>
