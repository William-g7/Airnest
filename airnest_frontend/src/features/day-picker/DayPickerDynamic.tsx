...
// 动态导入DatePicker组件
const DaysPickerComponent = lazy(() => import('./DayPicker'));
...
// 动态DatePicker组件
export default function DaysPickerDynamic(props: DaysPickerProps) {
  return (
    <Suspense fallback={<DaysPickerSkeleton />}>
      <DaysPickerComponent {...props} />
    </Suspense>
  );
};