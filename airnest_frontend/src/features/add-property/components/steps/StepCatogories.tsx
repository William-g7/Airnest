...
export default function StepCategories({selectedCategory, setSelectedCategory } : StepCategoryProps) {
      ...
      {propertyCategories.map(category => (
        ...
        >
          <div className="w-10 h-10 relative">
            <Image src={category.icon} alt={t(category.value)} fill className="object-contain" />
          </div>
