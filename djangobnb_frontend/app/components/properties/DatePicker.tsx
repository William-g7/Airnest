...
const DatePicker: React.FC<DatePickerProps> = ({
    ...
    const timezoneLabel = propertyTimezone !== 'UTC'
        ? `(${propertyTimezone.replace('_', '/')})`
        : '';
                    ...
                    <>
                        <div className="space-y-3 p-4 bg-gray-50 border-b border-gray-200">
                            ...
                            <div className="flex items-start">
                                ...
                                <span>{datePickerT('cleaningTime')}: <span className="font-medium">2 {datePickerT('hours')}</span> {datePickerT('deepCleaning')}</span>
                            </div>
                        </div>
                    </>
                )}
