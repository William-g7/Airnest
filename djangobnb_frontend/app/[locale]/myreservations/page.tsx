                                        ...
                                        <div className="space-y-3 text-gray-600">
                                            <div className="flex flex-col space-y-1">
                                                <div className="flex flex-wrap items-center">
                                                    <span className="font-medium min-w-[70px]"><strong>{t('checkIn')}: </strong></span>
                                                    <span className="ml-2">
                                                        {formatLocalizedDate(reservation.check_in, reservation.property.timezone, 'long')}
                                                    </span>
                                            ...
                                            <div className="flex flex-col space-y-1">
                                                <div className="flex flex-wrap items-center">
                                                    <span className="font-medium min-w-[70px]"><strong>{t('checkOut')}: </strong></span>
                                                    <span className="ml-2">
                                                        {formatLocalizedDate(reservation.check_out, reservation.property.timezone, 'long')}
                                                    </span>
                                                    <span className="ml-2 text-sm bg-gray-100 text-gray-700 px-2 py-0.5 rounded-md">
